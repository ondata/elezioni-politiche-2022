...
curl --socks5-hostname localhost:9050 -s -kL "https://eleapi.interno.gov.it/siel/PX/votantiP/DE/20220925/TE/02/PR/002" \
  ...
  -H 'Pragma: no-cache' \
  -H 'Cache-Control: no-cache' -H 'TE: trailers' --compressed >"$folder"/test.json
